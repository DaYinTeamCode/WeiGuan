...
public class MD5Util {
	...
	public static String getAccountS(String username, String pwd) {
		...
		String temp = TextUtil.subStringFilter(username, 0, 2) + TextUtil.subStringFilter(pwd, 0, 2)
				+ TextUtil.subStringFilter(username, username.length() - 2, username.length())
				+ TextUtil.subStringFilter(pwd, pwd.length() - 2, pwd.length());

		return getAccountS(temp);
	}

	public static String getAccountS(String str) {

		return md5(md5(str).toLowerCase()).toLowerCase();
	}
