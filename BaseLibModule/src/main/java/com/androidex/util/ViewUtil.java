...
public class ViewUtil {
    ...
    /**
     * 清除imageview src 图片, 如果是bitmap，同时也对bitmap回收
     *
     * @param iv
     * @return
     */
    public static void clearAndRecycleImageViewDrawable(ImageView iv) {
     ...
     * @return
     */
    public static View inflateLayout(int layoutResId) {

        return LayoutInflater.from(ExApplication.getContext()).inflate(layoutResId, null);
    }

    /**
     * 加载一个宽度填充满父控件的的空白view
     *
     * @param context
     * @param heightPx
     * @return
     */
    public static View inflateSpaceVertView(Context context, int heightPx) {

        View v = new View(context);
        v.setLayoutParams(VglpUtil.getVglpSS(VglpUtil.M, heightPx));
        return v;
    }

    /**
     * 加载一个高度填充满父控件的的空白view
     *
     * @param context
     * @param widthPx
     * @return
     */
    public static View inflateSpaceHoriView(Context context, int widthPx) {

        View v = new View(context);
        v.setLayoutParams(VglpUtil.getVglpSS(widthPx, VglpUtil.M));
        return v;
    }

    /**
     * 加载一个宽度填充满父控件(ListView)的空白view
     * 因为ListView的header或footer必须是AbsListView.LayoutParams
     *
     * @param heightPx
     * @return
     */
    public static View inflateListViewSpaceHoriView(Context context, int heightPx) {

        View view = new View(context);
        view.setLayoutParams(new AbsListView.LayoutParams(VglpUtil.M, heightPx));
        return view;
    }
    ...
    public static XListView getCleanXListView(Context context, int id) {
        ...
        xlv.setVerticalScrollBarEnabled(false);//去滚动条
        xlv.setOverScrollMode(View.OVER_SCROLL_NEVER);
        return xlv;
    }
    ...
    public static void clearListViewRecyclerBin(AbsListView lv) {
        ...
        try {
            ...
            if (LogMgr.isDebug())
                LogMgr.d("### 清空AbsListView的RecycerBin ");
     ...
     * 设置带人民币符号文本
     */
    public static void setPriceText(TextView textView, String price, int rmbSizeDp,
                                    int priceSizeDp, Typeface typeface) {

        SpannableStringBuilder builder = new SpannableStringBuilder();
        builder.append(TextSpanUtil.getSpannableText("¥", rmbSizeDp, typeface));
        builder.append(TextSpanUtil.getSpannableText(price, priceSizeDp, typeface));
...
//	 * @return
//	 */
//	public static int measureTextViewHeight(Context context,String text, int textSize, int deviceWidth) {
//
