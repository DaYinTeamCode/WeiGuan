...
public abstract class ExRvAdapterBase<T, K extends ExRvItemViewHolderBase> extends RecyclerView.Adapter<ExRvItemViewHolderBase> {
    ...
    private ExRvItemViewHolderHeader mHeader;
    private ExRvItemViewHolderFooter mFooter;
    ...
    public void setLoadMorer(ExRvItemViewHolderFooter.ILoadMorer loadMorer, ExRvItemViewHolderFooter.ILoadMoreListener lisn) {
    ...
    private boolean initHeaderIfNull(Context context, int orientation) {
        ...
        if (mHeader == null) {
            ...
            mHeader = new ExRvItemViewHolderHeader(context, orientation);
    ...
    private boolean initFooterIfNull(Context context, int orientation) {
        ...
        if (mFooter == null) {
            ...
            mFooter = new ExRvItemViewHolderFooter(context, orientation);
