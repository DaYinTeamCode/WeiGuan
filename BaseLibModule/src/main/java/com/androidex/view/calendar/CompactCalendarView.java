...
public class CompactCalendarView extends View {
    ...
    public void setTypeface(Typeface mTypeface) {
        ...
        compactCalendarController.setTypeface(mTypeface);
        invalidate();
    }
    ...
    public void setDayFormartPreZero() {
        ...
        compactCalendarController.setDayFormartPreZero();
    }
    ...
    public void setCurrentCalendar(long millis){
        ...
        compactCalendarController.setCurrentCalendar(millis);
        invalidate();
    }
    ...
    public void setShouldDrawDaysHeader(boolean shouldDrawDaysHeader){
        ...
        compactCalendarController.setShouldDrawYearHeader(shouldDrawDaysHeader);

        if (shouldDrawDaysHeader)
            compactCalendarController.setRowCounts(8);//如果显示年分，则显示8行
        else
            compactCalendarController.setRowCounts(7);
    ...
    public void clearEvent(){
        ...
        compactCalendarController.clearEvent();
        invalidate();
    }
    /*
