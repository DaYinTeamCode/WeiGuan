...
public abstract class ImageLocalTask<Params, Progress, Result> {
    ...
    private static final String LOG_TAG = "ImageLocalTask";
...
//                    postResultIfNotInvoked(null);
    ...
    protected final ImageLocalTask<Params, Progress, Result> execute(Params... params)
    {
    ...
    protected final ImageLocalTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params)
    {
...
//        }
    ...
    private static class AsyncTaskResult<Data> {
        final ImageLocalTask mTask;
        final Data[] mData;

        AsyncTaskResult(ImageLocalTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
