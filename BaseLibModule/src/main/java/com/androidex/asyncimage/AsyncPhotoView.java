...
/**
 * copy了AsyncImageView代码, 实现异步加载
 * Created by yihaibin on 16/7/2.
 */
public class AsyncPhotoView extends PhotoView implements AsyncImageLoader.ImageCallback, ImageUtil.Constants{
    ...
    public AsyncPhotoView(Context context, AttributeSet attr) {

        this(context, attr, 0);
    }

    public AsyncPhotoView(Context context, AttributeSet attr, int defStyle) {
    ...
    public void setAsyncImageLoader(AsyncImageLoader loader){
    ...
    private void setAsyncImage(String imageUri, int destW, int destH, boolean isCache, int defDrawableRid, String defDrawableUri){
        ...
        mImageTask = mAsyncImageLoader.asyncLoadImage(imageUri, destW, destH, mIsImageHQ, isCache, mImageTag, this);
    ...
    @Override
    public Bitmap onImageLocalBitmapInBackground(String imageUri, Bitmap bmp) {

        return mAsyncImageLisn == null ? bmp : mAsyncImageLisn.onImageLocalBitmapInBackground(imageUri, bmp);
    }
